...
build/user/vm/mmap-over-data:     file format elf64-littleriscv
...
00000000000010be <printint>:
    ...
    10f0:	0007c783          	lbu	a5,0(a5) # 3000 <x>
...
00000000000013f6 <random_init>:
    ...
    140a:	0047a483          	lw	s1,4(a5) # 3004 <inited>
    ...
    1470:	00078423          	sb	zero,8(a5) # 3008 <s_j>
    1474:	000037b7          	lui	a5,0x3
    1478:	000784a3          	sb	zero,9(a5) # 3009 <s_i>
    147c:	000037b7          	lui	a5,0x3
    1480:	4705                	li	a4,1
    1482:	00e7a223          	sw	a4,4(a5) # 3004 <inited>
...
0000000000001496 <random_bytes>:
    ...
    14b0:	0047a783          	lw	a5,4(a5) # 3004 <inited>
