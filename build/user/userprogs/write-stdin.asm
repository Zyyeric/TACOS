...
build/user/userprogs/write-stdin:     file format elf64-littleriscv
...
0000000000001000 <main>:
    ...
    1018:	bde080e7          	jalr	-1058(ra) # 1bf2 <write>
    101c:	57fd                	li	a5,-1
    101e:	00f51563          	bne	a0,a5,1028 <main+0x28>
    1022:	60e2                	ld	ra,24(sp)
    1024:	6105                	addi	sp,sp,32
    1026:	8082                	ret
    1028:	469d                	li	a3,7
    102a:	00002637          	lui	a2,0x2
    102e:	c4060613          	addi	a2,a2,-960 # 1c40 <mkdir+0xe>
