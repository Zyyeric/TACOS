...
build/user/userprogs/wait-twice:     file format elf64-littleriscv
...
0000000000001000 <main>:
    ...
    100a:	c9050793          	addi	a5,a0,-880 # 1c90 <mkdir+0x10>
    100e:	e03e                	sd	a5,0(sp)
    1010:	e402                	sd	zero,8(sp)
    1012:	858a                	mv	a1,sp
    1014:	c9050513          	addi	a0,a0,-880
    1018:	00001097          	auipc	ra,0x1
    101c:	c00080e7          	jalr	-1024(ra) # 1c18 <exec>
    1020:	842a                	mv	s0,a0
    1022:	00001097          	auipc	ra,0x1
    1026:	bfe080e7          	jalr	-1026(ra) # 1c20 <wait>
    102a:	05100793          	li	a5,81
    102e:	00f51e63          	bne	a0,a5,104a <main+0x4a>
    1032:	8522                	mv	a0,s0
    1034:	00001097          	auipc	ra,0x1
    1038:	bec080e7          	jalr	-1044(ra) # 1c20 <wait>
    103c:	57fd                	li	a5,-1
    103e:	02f51c63          	bne	a0,a5,1076 <main+0x76>
...
00000000000010be <printint>:
    ...
    10de:	d4850513          	addi	a0,a0,-696 # 1d48 <digits>
    10e2:	883a                	mv	a6,a4
...
000000000000115a <vprintf>:
    ...
    11a4:	d48b0b13          	addi	s6,s6,-696 # 1d48 <digits>
    ...
    12d6:	d40d8493          	addi	s1,s11,-704 # 1d40 <mkdir+0xc0>
...
0000000000001376 <cksum>:
    ...
    1382:	d6060613          	addi	a2,a2,-672 # 1d60 <crctab>
    ...
    13ac:	d6060613          	addi	a2,a2,-672 # 1d60 <crctab>
...
0000000000001712 <memcmp>:
    ...
    1762:	16060613          	addi	a2,a2,352 # 2160 <crctab+0x400>
    1766:	000025b7          	lui	a1,0x2
    176a:	17058593          	addi	a1,a1,368 # 2170 <crctab+0x410>
    176e:	4509                	li	a0,2
    ...
    1798:	16060613          	addi	a2,a2,352 # 2160 <crctab+0x400>
    179c:	000025b7          	lui	a1,0x2
    17a0:	1b858593          	addi	a1,a1,440 # 21b8 <crctab+0x458>
    17a4:	4509                	li	a0,2
...
00000000000017d6 <memcpy>:
    ...
    181e:	16060613          	addi	a2,a2,352 # 2160 <crctab+0x400>
    1822:	000025b7          	lui	a1,0x2
    1826:	20058593          	addi	a1,a1,512 # 2200 <crctab+0x4a0>
    182a:	4509                	li	a0,2
    ...
    1854:	16060613          	addi	a2,a2,352 # 2160 <crctab+0x400>
    1858:	000025b7          	lui	a1,0x2
    185c:	24858593          	addi	a1,a1,584 # 2248 <crctab+0x4e8>
    1860:	4509                	li	a0,2
...
0000000000001990 <check_file_handle>:
    ...
    1a08:	29050513          	addi	a0,a0,656 # 2290 <crctab+0x530>
    ...
    1a28:	16078793          	addi	a5,a5,352 # 2160 <crctab+0x400>
    1a2c:	874e                	mv	a4,s3
    1a2e:	8652                	mv	a2,s4
    1a30:	000025b7          	lui	a1,0x2
    1a34:	36058593          	addi	a1,a1,864 # 2360 <crctab+0x600>
    1a38:	4509                	li	a0,2
    ...
    1a56:	3a850513          	addi	a0,a0,936 # 23a8 <crctab+0x648>
    ...
    1aa0:	160c8813          	addi	a6,s9,352 # 2160 <crctab+0x400>
    1aa4:	87aa                	mv	a5,a0
    1aa6:	8752                	mv	a4,s4
    1aa8:	86ca                	mv	a3,s2
    1aaa:	8622                	mv	a2,s0
    1aac:	2c0d8593          	addi	a1,s11,704 # 22c0 <crctab+0x560>
    1ab0:	4509                	li	a0,2
    ...
    1af0:	160c8793          	addi	a5,s9,352
    1af4:	8752                	mv	a4,s4
    1af6:	012606b3          	add	a3,a2,s2
    1afa:	40c58633          	sub	a2,a1,a2
    1afe:	308d0593          	addi	a1,s10,776 # 2308 <crctab+0x5a8>
    1b02:	4509                	li	a0,2
...
0000000000001b76 <check_file>:
    ...
    1bb0:	43050513          	addi	a0,a0,1072 # 2430 <crctab+0x6d0>
    ...
    1bdc:	16068693          	addi	a3,a3,352 # 2160 <crctab+0x400>
    1be0:	8626                	mv	a2,s1
    1be2:	000025b7          	lui	a1,0x2
    1be6:	3c858593          	addi	a1,a1,968 # 23c8 <crctab+0x668>
    1bea:	4509                	li	a0,2
